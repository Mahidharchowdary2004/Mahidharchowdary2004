...
|------------------|---------------------------|------------------|-----------------|------------|
| B.Tech (CSE)     | KL University, Guntur      | KLEF             | 9.16 | 2022-2026  |
...
## 🛠 Technical Skills
- **Programming Languages:** Java, SQL, Object-Oriented Programming (OOP)  
- **Frontend:** HTML, CSS, ReactJS, JSP
- **Backend:** Spring, Spring Boot, Hibernate, Node.js
- **Database:** MongoDB, MySQL, PostgreSQL
- **Testing & Quality:** JUnit, Selenium, Postman (API Testing)
- **Cloud & DevOps:** AWS, Git, GitHub, Scrum
- **Generative AI:** Tools: Cursor, Qoder, Vibe Coding Tools, Google AI Tools
...
- **Red Hat Certified Enterprise Application
    Developer**
- **Digital Skills Readiness Program – Java Full Stack (TalentNext) — Wipro Limited
Certificate ID: TNext SE 25 J 250891788**
